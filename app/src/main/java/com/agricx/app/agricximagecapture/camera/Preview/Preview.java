package com.agricx.app.agricximagecapture.camera.Preview;
...
import com.agricx.app.agricximagecapture.camera.CameraController.CameraController1;
import com.agricx.app.agricximagecapture.camera.CameraController.CameraController2;
import com.agricx.app.agricximagecapture.camera.CameraController.CameraControllerException;
...
public class Preview implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
    ...
    private int getTiltAngle(SensorEvent event) {
        int inclination = 0;
        try {
            float[] g = new float[3];
