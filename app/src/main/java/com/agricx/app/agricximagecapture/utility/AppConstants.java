...
public class AppConstants {
    ...
    public static final String AGRICX_IMAGES_FOLDER_NAME = "agricx";
    public static final String AGRICX_TRAINING_FOLDER_NAME = "agricx_training";
    public static final String DIALOG_FRAGMENT_TAG = "dialog_tag";
    public static final String DEFAULT_ALLOWED_CAMERA_ANGLE = "15";
