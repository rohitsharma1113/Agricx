package com.agricx.app.agricximagecapture.camera;
...
import com.agricx.app.agricximagecapture.camera.CameraController.CameraController;
import com.agricx.app.agricximagecapture.camera.Preview.ApplicationInterface;
import com.agricx.app.agricximagecapture.camera.Preview.Preview;
import com.agricx.app.agricximagecapture.camera.UI.DrawPreview;
...
//        gyroSensor.clearTarget();
    ...
    public void hasPausedPreview(boolean paused) {
        ...
        */
        ...
        View acceptDeclineContainer = main_activity.findViewById(R.id.acceptDeclineContainer);
        View takePhoto = main_activity.findViewById(R.id.take_photo);
        if (paused) {
            acceptDeclineContainer.setVisibility(View.VISIBLE);
            takePhoto.setVisibility(View.GONE);
        } else {
            acceptDeclineContainer.setVisibility(View.GONE);
            this.clearLastImages();
        }
    }
    ...
    private boolean saveImage(boolean is_hdr, boolean save_expo, List<byte[]> images, Date current_date) {
        ...
        Log.e(TAG, "angle :" + main_activity.getPreview().getLevelAngle());
